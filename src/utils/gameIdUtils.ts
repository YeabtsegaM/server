 ...
 */
export function generateGameId(sequentialId: number): string {
 ...
 */
export function formatGameIdForDisplay(gameId: string | number | undefined, includeTimestamp: boolean = false): string {
  if (!gameId) return '0';
...
export function isValidGameIdFormat(gameId: string | number): boolean {
  ...
  if (!/^\d{4}$/.test(gameIdStr)) return false;
 ...
 */
export function compareGameIds(gameId1: string | number, gameId2: string | number): number {
 ...
 */
export function generateGameIdWithTimestamp(gameId: string | number): string {
 ...
 */
export function parseTimestampedGameId(timestampedGameId: string): { baseId: string; timestamp: string } | null {
 ...
 */
export function shouldResetGameId(currentGameId: number, lastGameDate: Date | null): boolean {
