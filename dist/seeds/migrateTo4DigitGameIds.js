...
async function migrateTo4DigitGameIds() {
    try {
        ...
        const oldGames = await Game_1.default.find({
        ...
        if (oldGames.length > 0) {
            ...
            for (const game of oldGames) {
                try {
                    ...
                    await CompletedGame_1.default.create(gameToArchive);
        ...
        const invalidGames = await Game_1.default.find({
            $or: [
        ...
        const remainingGames = await Game_1.default.find({});
        ...
        try {
            const sampleGame = new Game_1.default({
                gameId: '4000',
                cashierId: null,
            ...
            await Game_1.default.deleteOne({ sessionId: 'sample-migration-test' });
...
exports.default = migrateTo4DigitGameIds;
//# sourceMappingURL=migrateTo4DigitGameIds.js.map