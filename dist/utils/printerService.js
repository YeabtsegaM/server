...
class PrinterService {
    ...
    async checkConnection() {
        try {
            ...
            const response = await axios_1.default.post(`${this.printerAgentUrl}/print`, {
     ...
     */
    async printBingoTicket(ticketData) {
        try {
...
[BARCODE:${ticketData.ticketNumber}]`;
     ...
     */
    async printMultipleBingoTickets(tickets) {
        const results = [];
