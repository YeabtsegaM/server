...
exports.fixSessionSync = fixSessionSync;
...
async function fixSessionSync() {
    try {
        ...
        const cashier = await Cashier_1.default.findOne({ username: 'yeab' }).exec();
        ...
        cashier.displayUrl = `http://localhost:3001?Bingo=${displaySessionId}`;
...
//# sourceMappingURL=fixSessionSync.js.map